#!/usr/bin/env python
"""
Threshold and connectivity segmentation and analysis of a cleft 

This script may be placed anywhere in the directory tree.

$Id: cleft.py 1078 2014-11-11 10:41:26Z vladan $
Author: Vladan Lucic 
"""
__version__ = "$Revision: 1078 $"
...
lay_col_suffix_2 = "-of-4.em"

# layers data type, 'uint8' , or
lay_col_data_type = 'uint8'        # if max segment id is not bigger than 255
#lay_col_data_type = 'uint16'         # more than 255 segments
