...
$Id: connectors.py 1130 2015-05-04 10:52:10Z vladan $
Author: Vladan Lucic 
"""
...
#  same in all labels files. Use 0 if segmentation region is not specified in
# boundary file. 
...
# (free_mode='add') or intersected (free_mode='intersect'). Not used if 
# read_connections is True. 
free_mode = 'add'
