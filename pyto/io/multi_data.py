...
# $Id: multi_data.py 992 2013-10-25 16:32:34Z vladan $
"""

__version__ = "$Revision: 992 $"
...
class MultiData(object):
    ...
    def readProperties(self, properties, index='ids', category=None,
        ...
        """
        Note depreciated, use readPropertiesGen() instead.
        ...
        ToDo: 
          - sort all properties by identifiers
          - finish docs
          - 
        """
